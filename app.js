...
const currentDragItem = {
    ...
    drag: function (e) {
        ...
        currentDragItem.setTranslate(currentDragItem.currentX, currentDragItem.currentY, currentDragItem.item);
    },
    ...
    dragEnd: function (e) {
        ...
        currentDragItem.currentX = currentDragItem.roundNum(currentDragItem.currentX, setScreen.gridSize)
        currentDragItem.currentY = currentDragItem.roundNum(currentDragItem.currentY, setScreen.gridSize)
        currentDragItem.setTranslate(currentDragItem.currentX, currentDragItem.currentY, currentDragItem.item);
...
const setScreen = {
    ...
    createGrid: function () {
        ...
        // vertical lines loop.
        for (let i = (this.windowSize.width / 2) % this.gridSize; i < window.screen.width; i += this.gridSize) {
            this.addGridLine(i, i, 0, window.screen.height);
        }
        // horizontal lines loop
        for (let i = (this.windowSize.height / 2) % this.gridSize; i < window.screen.height; i += this.gridSize) {
